...
if __name__ == '__main__':
    ...
    if args.dataset == 'miccai':
        network_module = importlib.import_module('models.MICCAI2012.{:s}.{:s}'.format(args.model, args.model))
        basepath = 'models/MICCAI2012/{:s}'.format(args.model)
        output_size = 135
    elif args.dataset in ['mrbrains_reduced', 'mrbrains_full']:
        network_module = importlib.import_module('models.MRBrainS.{:s}.{:s}'.format(args.model, args.model))
        basepath = 'models/MRBrainS/{:s}'.format(args.model)
